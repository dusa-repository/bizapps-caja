...
import servicio.maestros.SBanco;
import servicio.maestros.SCliente;
import servicio.maestros.SConcepto;
...
import servicio.transacciones.SDetalleNota;
import servicio.transacciones.SDetalleRecibo;
import servicio.transacciones.SNota;
import servicio.transacciones.SRecibo;
...
public abstract class CGenerico extends SelectorComposer<Component> {
	...
	@WireVariable("SBanco")
	protected SBanco servicioBanco;
	...
	@WireVariable("SConcepto")
	protected SConcepto servicioConcepto;
	@WireVariable("SProveedor")
	protected SProveedor servicioProveedor;
	@WireVariable("SEmpresa")
	protected SEmpresa servicioEmpresa;
	@WireVariable("SNota")
	protected SNota servicioNota;
	@WireVariable("SDetalleNota")
	protected SDetalleNota servicioDetalleNota;
	@WireVariable("SRecibo")
	protected SRecibo servicioRecibo;
	@WireVariable("SDetalleRecibo")
	protected SDetalleRecibo servicioDetalleRecibo;
	...
	public static SBanco getSBanco() {
		return applicationContext.getBean(SBanco.class);
	}

	public static SCliente getSCliente() {
		return applicationContext.getBean(SCliente.class);
	}

	public static SConcepto getSConcepto() {
		return applicationContext.getBean(SConcepto.class);
	}

	public static SNota getSNota() {
		return applicationContext.getBean(SNota.class);
	}

	public static SDetalleNota getSDetalleNota() {
		return applicationContext.getBean(SDetalleNota.class);
	}

	public static SProveedor getSProvedor() {
		return applicationContext.getBean(SProveedor.class);
	}

	public static SRecibo getSRecibo() {
		return applicationContext.getBean(SRecibo.class);
	}

	public static SDetalleRecibo getSDetalleRecibo() {
		return applicationContext.getBean(SDetalleRecibo.class);
	}
